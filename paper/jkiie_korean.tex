...
출고 트럭 $f\in F$가 도어 작업을 시작할 수 있는 가장 이른 시각이다.
...
(그림~\ref{fig:sel}). 이러한 부정적 결과는 무제약 조건만으로도 성립하므로 시간 제약
확장 때문에 나타난 결과가 아니다.
...
최적), 대형 시간 제약 조건에서는 수 초 안에 비교 방법 가운데 가장 좋은 해를 제공하였다.
...
비악화 1, 그 외 0)이다. agent는 \emph{train} 풀(S/M 규모, 모든 화물 분포·시간 제약 조건)에서 500회
