...
정하였다(\textbf{[TBD]}). % TODO: experiments/acceptance_tuning.py 결과로 채울 것
...
restart를 더하며, 확률적 acceptance 대신 greedy acceptance를 쓴다. 가장 중요한 차이는 개선 이동 이후의 descent이며, ablation은
...
% TODO: 이 문단의 [TBD]는 k1_stats.py / k1_summary.py 재실험 결과로 채울 것
실험 조건에서 GILS는 이에 근접하며, 기본 선택 정책인 균등 선택 기준으로 그 격차는
평균 \textbf{[TBD]}\%이다(학습 선택 정책을 포함한 전체 변형은 \textbf{[TBD]}\%). 같은 선택 정책 기준으로 VAA 대비
격차는 평균 \textbf{[TBD]}\%($n=$\textbf{[TBD]}, $p=$\textbf{[TBD]}), SA-RL5 대비 격차는 \textbf{[TBD]}\%($n=$\textbf{[TBD]}, $p=$\textbf{[TBD]})이다.
medium과 tight 조건에서 Extended SA-RL5 대비 격차는 평균 \textbf{[TBD]}\%($n=$\textbf{[TBD]}, $p=$\textbf{[TBD]})이다. 실행 시간은 S/M/L에서 각각 \textbf{[TBD]}초로, 같은 조건의
CP-SAT(76, 237, 376초)보다 \textbf{[TBD]}.
...
\midrule
S-none & VAA & 1497.5 ± 400.3 & \textbf{[TBD]} & +6.49 & 0.00\\
 & Paper-SA-RL5 & 1423.3 ± 383.6 & \textbf{[TBD]} & +1.21 & 0.15\\
 & GILS-uniform & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
 & GILS-tabular & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
 & GILS-DQN & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
S-medium & VAA & 5447.5 ± 1468.9 & \textbf{[TBD]} & +3.33 & 0.00\\
 & Extended-SA-RL5 & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
 & GILS-uniform & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
 & GILS-tabular & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
 & GILS-DQN & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
S-tight & VAA & 9276.8 ± 2387.6 & \textbf{[TBD]} & +2.17 & 0.00\\
 & Extended-SA-RL5 & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
 & GILS-uniform & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
 & GILS-tabular & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
 & GILS-DQN & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
M-none & VAA & 3030.9 ± 903.6 & \textbf{[TBD]} & +4.80 & 0.00\\
 & Paper-SA-RL5 & 2976.4 ± 864.4 & \textbf{[TBD]} & +0.99 & 0.55\\
 & GILS-uniform & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
 & GILS-tabular & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
 & GILS-DQN & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
M-medium & VAA & 23025.5 ± 4075.4 & \textbf{[TBD]} & --- & 0.00\\
 & Extended-SA-RL5 & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-uniform & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-tabular & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-DQN & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
M-tight & VAA & 38903.7 ± 11283.5 & \textbf{[TBD]} & --- & 0.01\\
 & Extended-SA-RL5 & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-uniform & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-tabular & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-DQN & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
L-none & VAA & 5492.3 ± 1482.2 & \textbf{[TBD]} & --- & 0.02\\
 & Paper-SA-RL5 & 5479.7 ± 1449.5 & \textbf{[TBD]} & --- & 1.92\\
 & GILS-uniform & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-tabular & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-DQN & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
L-medium & VAA & 55611.1 ± 18087.3 & \textbf{[TBD]} & --- & 0.02\\
 & Extended-SA-RL5 & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-uniform & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-tabular & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-DQN & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
L-tight & VAA & 119671.9 ± 32475.3 & \textbf{[TBD]} & --- & 0.02\\
 & Extended-SA-RL5 & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-uniform & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-tabular & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
 & GILS-DQN & \textbf{[TBD]} & \textbf{[TBD]} & --- & \textbf{[TBD]}\\
...
% TODO: 재실험 후 아래 단조 감소·유의성 서술이 여전히 성립하는지 확인할 것
...
Contrast & n & Gain(\%p) & p\\
\midrule
generic → critical (add g1, g2) & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
critical → full (add g3, g4) & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
generic → full (all guided) & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
\bottomrule
\end{tabular}
\end{table}
...
<Figure~\ref{fig:comp}>) \textbf{[TBD: 재실험 결과 서술]}.
...
\midrule
remove best-improvement descent & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
remove kick restart & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
random start instead of VAA & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
add SA acceptance + reheating & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
\bottomrule
\end{tabular}
\end{table}
...
% TODO: 재실험 후 아래 서술(균등 선택 우위, 반복 횟수별 방향 전환)이 성립하는지 확인할 것
...
\midrule
tabular vs uniform & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
tabular vs DQN & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
uniform vs DQN & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]}\\
\bottomrule
\end{tabular}
\end{table}

\subsection{6.4 Tardiness-weight 민감도}
% TODO: 최종 엔진(균등 선택, greedy)으로 lambda_sensitivity.py 재실행 후 서술과 수치 확인
...
대부분은 $\lambda=0$에서 $1$ 사이에서 일어나고 이후에는 그 폭이 줄어든다. 전체 탐색 구간에서 평균
총 작업완료시간은 약 \textbf{[TBD]}\% 상승, 평균 납기지연은 \textbf{[TBD]}\% 하락한다. $\lambda=1$을 채택한다:
...
평탄해짐을 보인다. 정체 탈출은 kick restart가 맡으므로 SA acceptance와 reheating의 역할은
이와 겹치며, 조정 집합 비교와 시험 집합 ablation에서 이 둘이 해 품질을 높이지 않아 최종
VAA-GILS에서 제외하였다(\textbf{[TBD]}). 즉 본 문제에서 성능의 본질은 학습된 선택 정책이나
확률적 acceptance가 아니라 bottleneck-guided 연산자, 결정론적 descent, kick restart에 있다.
...
기준해가 있는 실험 조건에서 VAA-GILS의 목적값은 해당 기준해 대비 평균 \textbf{[TBD]}\%였고(소형 무제약
조건에서는 CP-SAT가 최적성을 증명하였다), 대형 시간 제약 조건에서는 \textbf{[TBD: 재실험 후 서술]}.
ablation은 성능이 best-improvement descent, guided 이동, kick restart라는 결정론적
