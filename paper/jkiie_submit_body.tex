...
VAA-GILS는 iterated local search의 구현체로, 연산자 선택, 연산자 내부 sampling, kick을
...
greedy 규칙이다. 이 규칙은 조정 집합에서 simulated annealing acceptance(초기 온도
...
Objective & Makespan & Makespan + λ · total tardiness \\
\bottomrule
\end{tabular}
\end{table}
...
medium과 tight 조건에서 Extended SA-RL5 대비 격차는 평균 0.89\%($n=120$, $p<0.0001$)이다. 실행 시간은 S/M/L에서 각각 0.09, 0.55, 3.17초로, 같은 조건의
CP-SAT(76, 237, 376초)보다 100배 이상 빠르다.
